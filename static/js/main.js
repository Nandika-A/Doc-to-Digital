...
async function importAnimationsAndModel(model) {
    await importAnimations("static/animations/F_Standing_Idle_001.glb");
...
function importAnimations(animation) {
    ...
    return BABYLON.SceneLoader.ImportMeshAsync(null, "static/animations/" + animation, null, scene)
      .then((result) => {
